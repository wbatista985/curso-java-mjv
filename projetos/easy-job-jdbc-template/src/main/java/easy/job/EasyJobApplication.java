...
public class EasyJobApplication {
	...
	private static void buscarProfissao() {
		...
		if(profissao!=null) {
			...
			System.out.println("N�o foi localizado a profissao com o nome PROGRAMADOR");
		}
	}
	...
	private static void updateProfissao() {
		Profissao profissao = repository.findById(6);
		if(profissao==null) {
			System.out.println("Desculpa n�o localizamos a profissao pelo id " + 1);
